...
CREATE TABLE MANUTENCAO_TRATADORES (
    ...
    id_tratador     NUMBER NOT NULL,
    PRIMARY KEY (id_manutencao, id_tratador),
    FOREIGN KEY (id_manutencao) REFERENCES MANUTENCAO(id_manutencao),
    FOREIGN KEY (id_tratador) REFERENCES TRATADOR(cpf_funcionario) 
);

CREATE TABLE DATA_CONTRATO (
    num_carteira_trabalho NUMBER PRIMARY KEY,
